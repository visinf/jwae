...
import torch
from model import JWAE, xattn_score_t2i, xattn_score_i2t
...
def encode_data(model, data_loader, log_step=10, logging=print):
	...
	for i, (images, captions, lengths, ids) in enumerate(data_loader):
		...
		with torch.no_grad():
			...
			img_emb, cap_emb, cap_len,_,_ = model.forward_emb(images, captions, lengths)
			#print(img_emb)
			if img_embs is None:
				if img_emb.dim() == 3:
...
best_sum_top_10_test = 0;



def evalrank(model_path, max_sum_top_k_test,max_sum_top_10_test,max_sum_top_5_test,max_sum_top_1_t2i,max_sum_top_10_t2i,max_sum_top_5_t2i, data_path, split='dev', fold5=True):
	"""
	...
	if not fold5:
		...
		sum_top_5_t2i = ri[1]
		sum_top_10_t2i = ri[2]
			#best_sum_top_10_test = max(sum_top_10_test,best_sum_top_10_test)
		#print(sum_top_10_test,sum_top_5_test,sum_top_k_test)
		max_sum_top_k_test = max(max_sum_top_k_test,sum_top_k_test)
		max_sum_top_10_test = max(max_sum_top_10_test,sum_top_10_test)
		max_sum_top_5_test = max(max_sum_top_5_test,sum_top_5_test) 
		max_sum_top_1_t2i = max(max_sum_top_1_t2i,sum_top_1_t2i)
		max_sum_top_10_t2i = max(max_sum_top_10_t2i,sum_top_10_t2i)
		max_sum_top_5_t2i = max(max_sum_top_5_t2i,sum_top_5_t2i)
		...
		for i in range(5):
			...
			#best_sum_top_10_test = max(sum_top_10_test,best_sum_top_10_test)
		#print(sum_top_10_test,sum_top_5_test,sum_top_k_test)
		max_sum_top_k_test = max(max_sum_top_k_test,sum_top_k_test/5)
		max_sum_top_10_test = max(max_sum_top_10_test,sum_top_10_test/5)
		max_sum_top_5_test = max(max_sum_top_5_test,sum_top_5_test/5) 
		max_sum_top_1_t2i = max(max_sum_top_1_t2i,sum_top_1_t2i/5)
		max_sum_top_10_t2i = max(max_sum_top_10_t2i,sum_top_10_t2i/5)
		max_sum_top_5_t2i = max(max_sum_top_5_t2i,sum_top_5_t2i/5)
	...
	return max_sum_top_k_test,max_sum_top_10_test,max_sum_top_5_test,max_sum_top_1_t2i,max_sum_top_10_t2i,max_sum_top_5_t2i
